...
def callback(data):
	...
	global velocity_pitch, velocity_roll, velocity_yaw
	...
	controller.cmd_vel.linear.x = velocity_x # roll
	controller.cmd_vel.linear.y = -velocity_y # pitch
	controller.cmd_vel.linear.z = -velocity_z # altitude
	controller.cmd_vel.angular.z = -velocity_yaw # yaw
